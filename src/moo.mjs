// Forked from https://github.com/no-context/moo for unicode support
// see https://github.com/no-context/moo/issues/116
...
function compileRules(rules, hasStates) {
  ...
  var flags = hasSticky && !fallbackRule ? "yum" : "gum";
...
function checkStateGroup(g, name, map) {
  ...
  if (g && g.pop && +g.pop !== 1) {
    throw new Error(
      "pop must be 1 (in token '" + g.defaultType + "' of state '" + name + "')"
    );
  }
}
...
Lexer.prototype.has = function (_tokenType) {
  return true;
};
