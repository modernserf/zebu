...
const xmlisp = grammar`
  ...
  TagBody  = TagHead ("|" line?) Body (line? "|") Tag  
             : ${(obj, _, children, __, closeTag) => {
               assert.strictEqual(obj.type, closeTag);
               return { ...obj, children };
             }}
           | TagHead
  TagHead  = Tag line? Attrs      : ${(type, _, attrs) => ({
    type,
    attrs,
    children: [],
  })}
  ...
  Attrs    = Attr ** line?        : ${(objs) =>
    objs.reduce((l, r) => Object.assign(l, r), {})}
  ...
  expect(doc).toEqual([
    {
      ...
      children: [
        ...
        {
          type: "link",
          attrs: { rel: "stylesheet", href: "theme.css" },
          children: [],
        },
      ],
    },
